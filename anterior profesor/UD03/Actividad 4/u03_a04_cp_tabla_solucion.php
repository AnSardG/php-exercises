 ...
 */
     ...
     */
        ...
        /**
         * Verifica que la fila y la columna introducida esté dentro del dominio de valores
         * correspondiente a la tabla; en caso de ser correcto, se muestra un mensaje que indica
         * la fila y columna específica de la tabla de multiplicación, junto al valor de dicha
         * posición. El valor se obtiene restandole a ambos índices 1 ya que las posiciones 
         * comienzan desde 0.
         * 
         * Si la condición if no se cumple, se lanza una excepción con un mensaje de 
        ...
        try {
            if ($fila <= $filas && $columna <= $columnas) {
                 ...
                 * parecida a la anterior ya analizada (bucle for anidado, uno para filas, otro 
                 * para columnas).
                 */
        ...
        /**
         * Se captura la excepción lanzada y se almacena en la variable $excepcion, el mensaje
         * de dicha excepción se pasará como variable de sesión "mensaje" y finalmente
         * redirigirá al usuario a la página anterior "u03_a04_cp.php" con el metodo "header()".
         */
